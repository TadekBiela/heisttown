...
void PrintTo(const HandleParams& params, std::ostream* stream)
{
    *stream << "HandleParams: "
            << "inputEvents.size=" << params.inputEvents.size()
            << ", expectedMoveDirection=" << static_cast<int>(params.expectedMoveDirection)
            << ", expectedMoveVelocity=" << params.expectedMoveVelocity;
}
